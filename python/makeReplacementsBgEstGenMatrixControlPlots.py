...
# for execution of 'cmsRun prodGenMatrixControlPlotsZto.._cfg.py' jobs on the CERN batch system
#
...
#       specific to the prodGenMatrixControlPlotsZto.._cfg.py config file (templates),
...
def makeReplacementsBgEstGenMatrixControlPlots(channel = None, sample = None, replacements = None):
    ...
    #   genPhaseSpaceCut and plotsOutputFileName
