...
outputFilePath = "/castor/cern.ch/user/v/veelken/CMSSW_3_3_x/plots/ZtoMuTau_tauIdEffKineEventReweights/7TeV/"
...
# Z --> tau+ tau- jobs
for i in range(16):
    submitToBatch(configFile = "runKineEventReweightProductionTauIdEffZtoMuTau_cfg.py", channel = "ZtoMuTau",
                  ...
                  job = "tauIdEffKineEvtRewProd", queue = "1nd", outputFilePath = outputFilePath)
